...
const styles = {
  dropdownTrigger: 'w-full bg-transparent cursor-pointer flex justify-between items-center text-black border-none',
  dropdownMenu: 'absolute z-50 top-full left-0 w-full mt-1 bg-white rounded-[12px] shadow-lg max-h-60 overflow-auto',
...
const Dropdown: React.FC<{
  ...
  return (
    <div className="relative w-full" ref={wrapperRef}>
      <div className={styles.dropdownTrigger} style={{ paddingBlock: '9px', paddingInline: '16px' }} onClick={() => setIsOpen(!isOpen)}>
        ...
        <div className={styles.dropdownMenu}>
          {isSearch && (
            <div className={styles.searchWrapper}>
              <div className="flex items-center gap-2 bg-gray-100 rounded border-b border-gray-500" style={{paddingInline:'4px', paddingBlock:'2px'}}>
                <SearchIcon />
                <input
          ...
          <div className="py-1">
            {filteredOptions.length === 0 && <div className="text-sm text-center" style={{padding: '3px'}}>No options</div>}
